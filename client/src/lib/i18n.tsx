...
const translations: Translations = {
  de: {
    ...
    "nav.about": "Kanzlei",
    "nav.contact": "Kontakt",
    "hero.title": "Kompetente Steuerberatung in München",
    ...
    "about.title": "Über Kanzlei Schneider",
  ...
  en: {
    ...
    "nav.about": "About Us",
    "nav.contact": "Contact",
    "hero.title": "Expert Tax Consulting in Munich",
    ...
    "about.title": "About Schneider Firm",
